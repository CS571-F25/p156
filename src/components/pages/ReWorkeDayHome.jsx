            ...
            <Container className="py-5">
                ...
                <Row className="w-100 justify-content-center">
                    <Col xs={12} md={4} className="d-flex justify-content-center mb-3">
                        <Card>
                            <Card.Body className="text-center">
                                <Image fluid src={elegant} alt="Tablet and clipboard displaying identical sketches of folders and checkboxes"/>
                    ...
                    <Col xs={12} md={4} className="d-flex justify-content-center mb-3">
                        <Card>
                            <Card.Body className="text-center">
                                <Image fluid src={landingimg} alt="Sketch of happy office workers raising their arms"/>
                ...
                <Row className="justify-content-center align-items-center">
                    ...
                    <Col xs={12} md={6} className="d-flex justify-content-center align-items-center mb-3">
                        <div style={{width: "100%", maxWidth: "24rem"}}>
                            <Image src={bottomline} fluid style={{ border: "1px solid lightgray", borderRadius: "0.6767rem" }} alt="Cartoon of a recruiter reviewing an application and a candidate holding a tablet"/>
                        </div>
                    </Col>
