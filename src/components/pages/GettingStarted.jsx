                ...
                <Card.Title><h1>Getting started with ReWorkeDay</h1></Card.Title>
                    ...
                    </div>
                    {
                        ...
                        <Container>
                            <Card>
                                <Card.Body>
                                    <Card.Img variant="top" src={applicantgettingstarted} alt="Cartoon illustration of people collaborating with job application sketches in the background"/>
                    ...
                    }
                    {
                        ...
                        <Container>
                            <Card>
                                <Card.Body>
                                    <Card.Img variant="top" src={bottomline} alt="Two men reviewing and submitting job applications seperately on a computer and tablet"/>
