                                                ...
                                                if (inputType === "checkbox") {
                                                    return (
                                                        <Form.Group className="mb-1" key={i}>
                                                            <div className="d-flex align-items-center mb-2">
                                                                ...
                                                                <Form.Check className="mb-2" type="checkbox" defaultChecked={response}/>
                                                            </div>
                                                        </Form.Group>
                                                    );
                                                    ...
                                                    return (
                                                        <Form.Group className="mb-1" key={i}>
                                                            ...
                                                            <Form.Control className="mb-3" disabled value={"file would go here"} type={"text"} required={required}/>
                                                        </Form.Group>
                                                    );                                                    
                                                } else {
                                                    return (
