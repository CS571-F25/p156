...
export default function Posting() {
    const templates = {
        Basic: [
            { type: "info", label: "Introduction", content: "", input: "none", required: ""},
            { type: "form", label: "Full Name", content: "", input:"text", required: ""}
